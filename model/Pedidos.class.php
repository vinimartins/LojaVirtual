...
class Pedidos extends Conexao {
	...
	/*Busca todos dados da tabela de pedidos cruzando com a tabela cliente, pra ver se na tbl PEDIDO tem algum pedido com ID do cliente
        */
...
/*Se o o cliente existir, cria-se uma variavel para guardar um valor inteiro, já que será passada a id do cliente, evitando a SQLINJECTION
e faz um filtro para ver se os pedidos são daquele mesmo cliente
 */
		if ($cliente != null) {
			$cli = (int) $cliente;
        ...
        */
		...
		/*Pra utilizar os dados da tabela pra imprimir na tela, como foi feito em produtos e categorias
         */
		$this->GetLista();
	}
