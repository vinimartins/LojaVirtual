...
Class Produtos extends Conexao {
	...
	function GetProdutosNome($nome) {
		...
		/*Para buscar valor aproximado é com LIKE e com %percentual%
		*/
	...
	private function GetLista() {
		...
		while ($lista = $this->ListarDados()):
			$this->itens[$i] = array(
				...
				/*Vai lá na raiz do site e vai até a imagem do produto
				*/
				'pro_img_arquivo' => Rotas::get_SiteRAIZ() . '/' . Rotas::get_ImagePasta() . $lista['pro_img'],

				/*lista o que existe desta imagem*/
	...
	/*Função sendo chamada na parte de ADM da loja, para excluir os produtos.
	*/
	function Apagar($id) {
		...
		*/
		...
		/*Onde a ID do produto seja igual ao que seja passado no parâmetro da função
		*/
		$query .= " WHERE pro_id = :id";

		/*Atribuindo valor ao parâmetro, recebendo o */
		$params = array(
			':id' => (int) $id,
		);
